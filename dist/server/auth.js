...
var AUTH0_AUDIENCE = config_1.default.AUTH0_AUDIENCE, AUTH0_DOMAIN = config_1.default.AUTH0_DOMAIN;
...
exports.checkRole = function (role) { return function (req, res, next) {
    var assignedRoles = req.user['http://localhost:3000/roles'];
    if (Array.isArray(assignedRoles) && assignedRoles.includes(role)) {
        return next();
    }
    return res.status(401).send('Insufficient Role');
}; };
exports.default = { checkScope: exports.checkScope, checkJwt: exports.checkJwt, checkRole: exports.checkRole };
